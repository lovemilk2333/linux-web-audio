...
func run() error {
	...
	flag.IntVar(&opts.complexity, "complexity", 3, "encoder effort, where the codec has one")
	flag.Float64Var(&opts.frameDuration, "frame-duration", 5, "frame duration in ms (Opus accepts 2.5, 5, 10, 20, 40, 60)")
